 	...
 	b.tripShowInit = function() {
 		...
 		t.ready(function() {
 			...
 			WindowResizeListener.add(function() {
 				...
 				//c.css({width: WindowSize.width,height: $(document).height()});
 			});
 			...
 			//c.css({width: WindowSize.width,height: WindowSize.height,overflow: "hidden"});
 			c.css({
 				width: WindowSize.width,
 				height: WindowSize.height
 			});
 			//c.css({height: $(document).height(),"overflow":"scroll","overflow-x":"hidden"});
 			//窗口滚动条隐藏
 			var f = function(a) {
 				v.visibility || v.show();
 				var b = q.findNote(a);
