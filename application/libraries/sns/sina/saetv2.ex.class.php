...
class SaeTOAuthV2 {
	 ...
	 * @ignore
	 */
	public $useragent = '1001 Magazine v1';
...
class SaeTClientV2
{
	 ...
	 * @return array
	 */
	function upload( $status, $pic_path, $lat = NULL, $long = NULL,$annotations=null )
	{
		$params = array();
		$params['status'] = $status;
		$params['pic'] = '@'.$pic_path;
	 ...
	 * @return array
	 */
	function upload_url_text( $status,  $url,$annotations=null )
	{
		$params = array();
		$params['status'] = $status;
		$params['url'] = $url;
